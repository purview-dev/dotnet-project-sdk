...
{
	[Test]
	public async Task InternalsVisibleTo_Generated_For_NonTestProjects_ByDefault(
	...
	)
	{
		...
		await Assert
			.That(assemblyAttrs)
			.Contains("System.Runtime.CompilerServices.InternalsVisibleToAttribute");
	}

	[Test]
	public async Task InternalsVisibleTo_CanBeDisabled_ViaProperty(
		CancellationToken cancellationToken
	)
	{
	...
	[Test]
	public async Task DisableAutoInternalsVisibleTo_Property_Defaults_To_False(
		CancellationToken cancellationToken
	)
	{
	...
	[Test]
	public async Task DisableAutoInternalsVisibleTo_CanBeSetToTrue(
		CancellationToken cancellationToken
	)
	{
	...
	[Test]
	public async Task TestProject_AlwaysHasInternalsVisibleToAttribute_ForMocking(
		CancellationToken cancellationToken
	)
	{
	...
	[Test]
	public async Task InternalsVisibleTo_AlwaysIncludesDynamicProxyGenAssembly2(
		CancellationToken cancellationToken
	)
	{
